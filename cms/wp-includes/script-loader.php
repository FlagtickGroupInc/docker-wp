...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'admin-bar', "/wp-includes/admin/partial/topbar/assets/js/admin-bar$suffix.js", array( 'hoverintent-js' ), false, 1 );
...
function wp_default_styles( $styles ) {
    ...
    $styles->add( 'admin-menu', "/wp-includes/admin/partial/sidebar/assets/css/admin-menu$suffix.css" );
	...
	// Includes CSS.
	$styles->add( 'admin-bar', "/wp-includes/admin/partial/topbar/assets/css/admin-bar$suffix.css", array( 'dashicons' ) );
